...
void VirtualWorldCycle()
{
	...
	{                              // nale¿y na nowo obliczyæ œredni czas cyklu avg_cycle_time
		...
		sprintf(text, "WZR 2022/23, tem.3, wersja a, czêstoœæ pr.wys. = %0.2f[r/s]  œr.odl = %0.3f[m]  œr.ro¿n.k¹t. = %0.3f[st]",
	...
	int       nCmdShow)
{
	...
	window_handle = CreateWindow(class_name, "WZR 2022/23 temat 3 Naw.obl., wersja a", WS_OVERLAPPEDWINDOW | WS_VISIBLE | WS_CLIPCHILDREN | WS_CLIPSIBLINGS,
		500, 50, 850, 670, NULL, NULL, hInstance, NULL);
